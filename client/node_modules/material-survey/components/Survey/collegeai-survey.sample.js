...
const questionList = exports.questionList = [{
  name: "major-category",
  ...
  validators: [{
    ...
    minValue: 1,
    maxValue: 200,
    text: "Use the scale your school uses. e.g. 3.7 in a 4 point system, or 92 in a 100 point system."
  }],
  required: true
}, {
  ...
  validators: [{
    ...
    minValue: 1,
    maxValue: 200,
    text: "What is the highest GPA a student could get without any weighting at your school?"
  }],
  required: true
}, {
  ...
  columns: [{
    ...
    title: "Score",
    cellType: "dropdown",
    choices: (0, _range2.default)(800, 0, -10).map(n => ({
      value: n,
      text: n.toString()
    }))
  }],
  ...
  columns: [{
    ...
    title: "Score",
    cellType: "dropdown",
    choices: (0, _range2.default)(1, 5).map(n => ({
      value: n,
      text: n.toString()
    }))
  }],
  ...
  type: "radiogroup",
  choices: importanceChoices // importance	false		"
  ...
  title: "Do you want to go to anywhere specific in the US? If so, select the regions.",
  type: "multiple-us-region"
}, {
  name: "preferred-region-importance",
  title: "How important is it that you go to college in the regions you selected?",
...
exports.default = questionList.reduce((acc, q) => {
  acc[q.name] = q;
  return acc;
}, {});